const translations = {
  vi: {
    ...
    metaDescription: "Trang tong hop cac project y nghia cho gia dinh, nguoi yeu, va cong viec ca nhan.",
    nav: {
      projects: "Projects",
    ...
    hero: {
      ...
      panelTwoBody: "Xem nhanh tung website ngay trong hub thay vi mo tung tab rieng.",
      panelThreeTitle: "Reflect",
      panelThreeBody: "Gan moi project voi mot muc hoc ky thuat de portfolio cung tro thanh phong lab ca nhan.",
    },
    stats: {
      total: "tong project",
      family: "danh cho gia dinh",
      girlfriend: "danh cho nguoi yeu",
      personal: "personal and work",
    },
    collections: {
      label: "Bo suu tap",
      title: "Ba mach y nghia, mot kho luu tru ca nhan.",
      familyTag: "Nhanh gia dinh",
      familyTitle: "Nhung project ton vinh sinh nhat, ky niem, va su gan gui.",
      familyBody: "Day la nhung website am ap, tran trong, thien ve ky niem va phu hop de tro thanh mon qua lau dai cho nguoi than.",
      girlfriendTag: "Nhanh nguoi yeu",
      girlfriendTitle: "Nhung project bien tinh cam thanh trai nghiem lang man va vui choi.",
      girlfriendBody: "Day la nhung microsite va bat ngo tuong tac: hoa, game, dip le, am nhac, va loi nhan rieng.",
      personalTag: "Nhanh ca nhan va cong viec",
      personalTitle: "Nhung project phuc vu kinh doanh, thuong hieu, va hinh anh chuyen nghiep.",
      personalBody: "Day la cac website portfolio, landing page kinh doanh, va nhung san pham giup ban vua hoc vua tang do tin cay nghe nghiep.",
    },
    projects: {
      label: "Project Hub",
    ...
    preview: {
      ...
      emptyTitle: "Re chuot vao mot project de xem nhanh tai day.",
      emptyBody: "Khung ben se hien mo ta, tag, muc tieu va sau do thu tai website that.",
      audienceFamily: "Gia dinh",
      audienceGirlfriend: "Nguoi yeu",
      audiencePersonal: "Ca nhan / Work",
      goalLabel: "Muc tieu",
      urlLabel: "Lien ket",
      openSite: "Mo website",
    ...
    workflow: {
      ...
      title: "Dung project ca nhan nhu mot san tap engineering that su.",
      stepOneTitle: "1. Xay cho cam xuc",
      stepOneBody: "Bat dau tu mot muc dich that: mon qua sinh nhat, album ky niem, bat ngo cho nguoi yeu, hay mot trai nghiem dip le.",
      stepTwoTitle: "2. Moi project hoc 1 ky nang kho",
      stepTwoBody: "Gan moi lan build voi mot bai hoc ro rang nhu animation, 3D, CI/CD, accessibility, testing, hoac CMS.",
      stepThreeTitle: "3. Giu vong lap engineering",
      stepThreeBody: "Sau khi ship, ghi lai dieu gi hieu qua, thu gi co the tai su dung, va buoc tiep theo can nang cap. Moi mon qua se tro thanh mot lan tang level.",
    },
    filters: {
      all: "Tat ca",
      family: "Gia dinh",
      girlfriend: "Nguoi yeu",
      personal: "Ca nhan / Work",
    },
    cards: {
      yearPrefix: "Nam",
      open: "Mo site",
